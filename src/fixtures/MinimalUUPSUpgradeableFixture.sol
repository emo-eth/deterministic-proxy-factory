...
library MinimalUUPSUpgradeableFixture {
    ...
    function setUpMinimalUUPSUpgradeable(bool enforceAddress) internal returns (address) {
        return setUpMinimalUUPSUpgradeable(MINIMAL_PROXY_INITCODE, enforceAddress);
    }
